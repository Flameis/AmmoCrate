class ACRoleInfoSouthernEngineer extends RORoleInfoSouthernEngineer;
...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
		...
		OtherItems=(class'ROGame.ROWeap_M34_WP',class'ROGame.ROWeap_C4_Explosive',class'AmmoCrate.ROItem_USAmmoCrate'),
