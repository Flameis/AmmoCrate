...
class ACVWeap_APC_HullMG extends ROVWeap_Transport_HullMG
	abstract
	HideDropDown;

defaultproperties
{
	WeaponContentClass(0)="AmmoCrate.ACVWeap_APC_HullMG_Content"
	SeatIndex=1
	...
	VehicleClass=class'ACVehicle_M113_APC'
...
//	WeaponFireWaveForm=ForceFeedbackWaveformShooting1
	...
	// Ammo
	AmmoClass=class'ACAmmo_127x99_M2Belt_APC'
	MaxAmmoCount=550
