...
class ACRoleInfoSouthernSupportAUS extends RORoleInfoSouthernInfantry;
...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_M16A1_AssaultRifle_Late',class'ROGame.ROWeap_L1A1_Rifle'),
					// Other items
